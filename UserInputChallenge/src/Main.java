...
public class Main {
    ...
    Before the user enters each number, print the message "Enter number #x:" where x represents the count, i.e. 1,
    2, 3, 4, etc.

    For example, the first message printed to the user would be �gEnter number #1:�h, the next �gEnter number #2: �h,
     and so on.
