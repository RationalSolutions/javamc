public class Main {
    ...
    /*
        ...
        HINT: To print on the same line, use the print method instead of println, e.g. System.out.print(" "); prints
        a space and does not "move" to another line.

        HINT: To "move" to another line, you can use an empty println call, e.g. System.out.println(); .

        NOTE: The printSquareStar method should be defined as public static like we have been doing so far in the
        course.
     */
